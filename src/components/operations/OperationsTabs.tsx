...
interface OperationsTabsProps {
  activeTab: 'batches' | 'vins' | 'logistics_setup' | 'production_setup' | 'zone_config' | 'system' | 'cost_tracking';
  onTabChange: (tab: 'batches' | 'vins' | 'logistics_setup' | 'production_setup' | 'zone_config' | 'system' | 'cost_tracking') => void;
}
  ...
  return (
    <div className="border-b border-gray-200 mb-4">
      <nav className="-mb-px flex space-x-8">
        ...
        <button
          onClick={() => onTabChange('zone_config')}
          className={`py-2 px-1 border-b-2 font-medium text-sm ${
