...
export function UserManagementTab({ onRefresh }: UserManagementTabProps) {
  ...
  const getRoleColor = (role: UserRole): string => {
    switch (role) {
      ...
      case UserRole.SCANNER: return 'bg-indigo-100 text-indigo-800';
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div>
          ...
          >
            ...
            <option value={UserRole.SCANNER}>Scanner</option>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-500 mb-4">
              User creation/editing form will be implemented in the next update.
            </p>
