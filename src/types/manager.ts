...
export type ManagerTab = 'checked' | 'expected' | 'transaction' | 'itemmaster' | 'scanner' | 'waste' | 'hr' | 'production_line' | 'production_stats' | 'car_tracking' | 'qa' | 'operations' | 'tasks' | 'feedback';
